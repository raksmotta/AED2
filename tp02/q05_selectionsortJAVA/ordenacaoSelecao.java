...
public class ordenacaoSelecao{
    ...
    public static Pokedex selectionsort (Pokedex mypokedex){
        ...
        for (int i = 0; i < n-1; i++){
            ...
            for (int j = i+1; j < n; j++){
                ...
                if (mypokedex.get(menor).get_name().compareTo(mypokedex.get(j).get_name()) > 0){
                    menor = j;
                }
            }

            mypokedex.swap(menor, i);
    ...
    public static void main(String[] args) {
        ...
        Pokedex myselectionpokedex = selectionsort(mypokedex);

        for (int x = 0; x < myselectionpokedex.size(); x++){
            System.out.println(myselectionpokedex.get(x).pokemonString());
        }
